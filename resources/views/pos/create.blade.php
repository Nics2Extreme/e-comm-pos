                    ...
                    <div class="invoice-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-end mb-50">
                                ...
                                <p class="inv-from-1">{{ env('APP_NAME') }}</p>
                                <p class="inv-from-1">(+63) 912 3456 789</p>
                                <p class="inv-from-1">admin@gmail.com</p>
                                <p class="inv-from-2">876 A. Bonifacio Avenue, Balintawak, Quezon City, Philippines</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-solid @error('pay') is-invalid @enderror" id="pay" name="pay" placeholder="(Example: ₱100000)" value="{{ old('pay') }}" autocomplete="off"/>
                            @error('pay')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
