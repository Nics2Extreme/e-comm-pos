            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        <!-- Product image -->
                        <img class="img-account-profile mb-2" src="{{ $product->product_image ? asset('storage/products/'.$product->product_image) : asset('assets/img/products/default.png') }}" alt="" id="image-preview" />
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group (storage) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="storage_id">Storage <span class="text-danger">*</span></label>
                            <select class="form-select form-control-solid @error('storage_id') is-invalid @enderror" id="storage_id" name="storage_id">
                                <option selected="" disabled="">Select a storages:</option>
                                @foreach ($storages as $storage)
                                <option value="{{ $storage->id }}" @if(old('storage_id', $product->storage_id) == $storage->id) selected="selected" @endif>{{ $storage->name }}</option>
                                @endforeach
                            </select>
                            @error('storage_id')
                            <div class="invalid-feedback">
