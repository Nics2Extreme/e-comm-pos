        ...
        <div class="page-header-content pt-4">
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('order.allOrders') }}">Orders</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('orders/due') }}">Due</a></li>
                    <li class="breadcrumb-item active">Due Order Details</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('pay') is-invalid @enderror" id="pay" name="pay" placeholder="(Example: ₱100000)" value="{{ old('pay') }}" autocomplete="off"/>
                            @error('pay')
