                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                    ...
                                    <option value="G-cash" @if(old('bank_name') == 'G-cash')selected="selected"@endif>G-cash</option>
                                    <option value="Paymaya" @if(old('bank_name') == 'Paymaya')selected="selected"@endif>Paymaya</option>
                                    <option value="BPI" @if(old('bank_name') == 'BPI')selected="selected"@endif>BPI</option>
                                    <option value="BDO" @if(old('bank_name') == 'BDO')selected="selected"@endif>BDO</option>
                                    <option value="Cash" @if(old('bank_name') == 'Cash')selected="selected"@endif>Cash</option>
                                </select>
                                @error('bank_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
